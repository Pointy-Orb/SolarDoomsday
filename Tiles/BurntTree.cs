...
public class BurntTree : ModTree
{
    ...
    public override void SetStaticDefaults()
    {
        ...
        texture = ModContent.Request<Texture2D>("SolarDoomsday/Tiles/BurntTree");
        branchesTexture = ModContent.Request<Texture2D>("SolarDoomsday/Tiles/BurntTree_Branches");
        topsTexture = ModContent.Request<Texture2D>("SolarDoomsday/Tiles/BurntTree_Tops");
    }
